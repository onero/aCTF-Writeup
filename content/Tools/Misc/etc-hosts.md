...
tags: [tools, enumeration, ctf]
summary: "Map IPs to friendly names using /etc/hosts to speed up workflows and make addresses memorable during CTFs and pentests."
---
